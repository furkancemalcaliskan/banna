...
- [x] Confirm `README.md`, `LICENSE`, `CONTRIBUTING.md`, `SECURITY.md`,
      ...
      repository.
- [ ] Move the `Unreleased` changelog entries into the versioned release
...
- [ ] Decide whether version `0.1.0` accurately communicates the public API and
      compatibility level.
- [ ] Write release notes that describe supported targets, limitations, and
...
- [ ] Verify checksums and executable names for every distributed platform.
