...
Actions workflow produces native archives for Linux x86-64 and ARM64, macOS
Intel and Apple Silicon, and Windows x86-64 and ARM64. Every archive contains
`banna`, `banna-cli`, the README, repository license, third-party notices, and
applicable LGPLv3/GPLv3 texts. Every archive has a SHA-256 checksum and GitHub
...
The custom release assets are executable bundles, their checksums, and the
